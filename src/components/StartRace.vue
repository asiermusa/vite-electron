...
<div class="text-caption font-weight-medium mt-4">Azken irteerak:</div>
  <v-chip-group column>
    <v-chip
...
window.ipc.send("toMain", ["get-server-time", null, true, eventIds]);
  ...
  if (isNaN(timestampNum)) {
    this.errorMessage = "Zerbitzariaren timestamp-a ez da zenbaki balioduna.";
    return;
  }
